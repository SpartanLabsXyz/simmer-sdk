...
Usage:
    ...
    python ai_divergence.py --min 10     # Only show >10% divergence
    python ai_divergence.py --bullish    # Only where Simmer > Poly
    python ai_divergence.py --bearish    # Only where Simmer < Poly
...
def main():
    ...
    parser.add_argument("--bullish", action="store_true", help="Only show bullish divergence (Simmer > Poly)")
    parser.add_argument("--bearish", action="store_true", help="Only show bearish divergence (Simmer < Poly)")
    ...
    if args.json:
        # Output filtered markets as JSON
