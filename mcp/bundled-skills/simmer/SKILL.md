...
No Python on the host? Every step here is also reachable over plain REST — see [docs.simmer.markets](https://docs.simmer.markets).
...
| Running on Grok Bot | Install into `workflows/`, see [runtimes#grok-bot](https://docs.simmer.markets/runtimes#grok-bot) |
